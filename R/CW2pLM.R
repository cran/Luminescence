CW2pLM <- structure(function(#Transform a CW-OSL curve into a pLM-OSL curve
  ### Transforms a conventionally measured continuous-wave (CW) curve into a 
  ### pseudo linearly modulated (pLM) curve using the equations given in Bulur (2000). 
  ...
  ### measured counts (cts) (\code{values[,2]}) can be provided.
  ...
  ##seealso<<
  ## \code{\link{CW2pHMi}}, \code{\link{CW2pLMi}}, \code{\link{CW2pPMi}}, 
